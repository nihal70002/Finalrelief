...
export default function TreatmentSection() {
  ...
  const treatmentOptions = [
    {
      ...
      shortDesc:
        "Complete replacement of the knee joint for severe arthritis and damage.",
      recoveryTime: "6-12 wks",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBeU9DWn6LIpel42xHoAleNWs7TPfcTqeqCeoLUGH_s6bug1K_JnZtccZsP6jexutDvT66wBMmWePSq06AtL9E_THU9a5LrImroXYgAp1GuQRjQyFMjTxuGb48p2Q5Z789ThdswZ2o3n-B5Vw5eNXgGIzPKj_I5a5EXpqSpTPc4MrkfvEe5B1n0bkJAWHAJyU5eJmQmxOfpfqmn7rkCZ03CfvEJX4ShsEpJnC-x1l1et85jXxl_j2aL8QfErLUZi5YxWOvju7jJDsji",
    },
    {
      id: "partial-knee-replacement",
      title: "Partial Knee Replacement",
      shortDesc:
        "Targeted replacement of only the damaged portion of the knee.",
    ...
    },
    {
      ...
      shortDesc:
        "Advanced techniques using smaller incisions for reduced trauma.",
    ...
    },
    {
      ...
      shortDesc:
        "Minimally invasive procedure using a camera to diagnose and treat knee problems.",
    ...
    },
    {
      ...
      shortDesc:
        "Non-surgical approaches including physical therapy, medication, and lifestyle modifications.",
      recoveryTime: "Varies",
      image: "/conse.jpeg",
    },
    {
      ...
      shortDesc:
        "Surgical repair of a torn anterior cruciate ligament to restore knee stability.",
      recoveryTime: "9-12 months",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDnBKAfpHfK4RlX-VGu2SOdU9ZhtDT2c5Lmq4MPpqaM_5QsWYNErJNYPJQTrSMhVO7vHT2rmdg0lObmaU1OVRmjhq-I_hCzkdV8svwe85kzjw_zae1WvTL6lKxWxXP0dJMHErMKrX7Z-w4OaTJXx8YYSFQlDM0GRnFC3JSvG9auEkbbWht2F9LJoHCIAQwf0Hm5HKgWUT98MCM5259PL-bqT7CJwEz9DGpCk2FnU_7T4CkFJNyH69gg3dQm_fi95A5E3X1WoiBUuBqS",
    },
    {
      id: "meniscus-surgery",
      title: "Meniscus Repair/Surgery",
      shortDesc:
        "Surgical treatment for torn meniscus cartilage in the knee.",
      recoveryTime: "4-12 wks",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAn1f0mcLZ8EbiKajdqlUhAeFQBCuTOuXRdwtpCjM7rpdmtulJPFzdEx9dbzOu3V2OlVTT3o4X0t9AGLyHVZR29K_TTJcvvJkHdcim7qBTz5TN4exk_ydxIZojXsI-ZZDyOEWyLwfZjMqwSPokkZPfALRCWkJZrgGYM7_eiEqDfHAIxEP_JdJhtLwNp85IHW7j3UUIJARSGBsoD7F0vFcxmutM-Pjlv-YjT0qWlUx1jNzCA4K3TzjqgmSem8jsrphWvIxx-4jijtqG1",
    },
    {
      id: "revision-surgery",
      title: "Revision Knee Surgery",
      shortDesc:
        "Replacement or repair of a previous knee implant that has failed or worn out.",
  ...
  return (
    <section
      id="treatment"
      ref={sectionRef}
      className="min-h-screen py-12 md:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 transition-colors"
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-3xl mx-auto text-base">
            Comprehensive surgical and non-surgical solutions tailored to your
            needs. Click on any treatment to learn more about the procedure,
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto">
          ...
          {treatmentOptions.map((treatment, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 group-hover:text-emerald-600 transition-colors leading-snug">
                {treatment.title}
              </h3>
