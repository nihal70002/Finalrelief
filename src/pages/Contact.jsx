...
export default function Contact() {
  return (
    <main>
      <SEO
        title="Contact Orthopedic Doctor in Manjeri | Dr Hydar Kunnummal"
        description="Contact Dr Hydar Kunnummal in Manjeri for orthopedic consultation, knee replacement, arthritis care, sports injury treatment and joint pain relief."
        path="/contact"
      />
