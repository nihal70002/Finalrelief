...
export default function Treatment() {
  return (
    <main>
      <SEO
        title="Knee Replacement Manjeri | Orthopedic Treatment | Dr Hydar Kunnummal"
        description="Explore knee replacement, arthritis treatment and sports injury care by Dr Hydar Kunnummal, orthopedic doctor in Manjeri, Kerala."
        path="/treatment"
      />
      <section className="bg-white dark:bg-gray-900 pt-28 pb-16">
        <div className="container mx-auto px-4 max-w-5xl">
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Orthopedic Treatments in Manjeri by Dr Hydar Kunnummal
          </h1>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
            Dr Hydar Kunnummal provides focused orthopedic treatment in Manjeri for patients from Malappuram and nearby areas. Care is planned after understanding each patient’s pain, mobility, diagnosis, lifestyle, and recovery goals.
          </p>
          ...
          <div className="mt-10 rounded-xl bg-emerald-50 dark:bg-gray-800 p-6 text-center">
            ...
            >
              Contact Dr Hydar Kunnummal for knee and joint pain care
            </Link>
          </div>
        </div>
      </section>
