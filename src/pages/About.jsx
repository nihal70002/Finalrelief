...
export default function About() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#111c21] font-sans text-[#0e171b] dark:text-slate-50 min-h-screen">
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        <div className="layout-container flex h-full grow flex-col">
          {/* Header */}
          <header className="sticky top-0 z-50 bg-slate-50/80 dark:bg-[#111c21]/80 backdrop-blur-sm">
            <div className="px-4 md:px-10 lg:px-20 xl:px-40 flex justify-center">
              <div className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-4 sm:px-6 md:px-10 py-3 w-full max-w-[1280px]">
                <div className="flex items-center gap-4 text-[#1791cf]">
                  ...
                  <h2 className="text-lg font-bold leading-tight tracking-tight dark:text-white">Dr. Hyder Kunnumal</h2>
                </div>
                <div className="hidden md:flex flex-1 justify-end gap-8">
                  <div className="flex items-center gap-9">
                    {/* Updated hrefs to use onClick for smooth scrolling */}
                    <a className="text-sm font-medium leading-normal hover:text-[#1791cf] dark:text-slate-300 dark:hover:text-[#1791cf]" href="#introduction" onClick={(e) => handleAnchorClick(e, 'introduction')}>About</a>
                    <a className="text-sm font-medium leading-normal hover:text-[#1791cf] dark:text-slate-300 dark:hover:text-[#1791cf]" href="#services">Services</a>
                    <a className="text-sm font-medium leading-normal hover:text-[#1791cf] dark:text-slate-300 dark:hover:text-[#1791cf]" href="#testimonials">Testimonials</a>
                    <a className="text-sm font-medium leading-normal hover:text-[#1791cf] dark:text-slate-300 dark:hover:text-[#1791cf]" href="#contact" onClick={(e) => handleAnchorClick(e, 'contact')}>Contact</a>
                  </div>
                ...
                <div className="md:hidden">
                  <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="p-2 rounded-md hover:bg-slate-200 dark:hover:bg-slate-800">
          ...
          <main className="flex-1 px-4 md:px-10 lg:px-20 xl:px-40 py-5">
            <div className="max-w-[1280px] mx-auto">
              {/* Hero Section */}
              {/* NOTE: Hero is usually the first thing and doesn't need scroll-margin */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-12 items-center">
                  ...
                  <div className="lg:col-span-3 flex flex-col gap-6 text-left">
                    <div className="flex flex-col gap-4">
                      <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tighter dark:text-white">
                        Meet Dr. Hyder Kunnumal: Pioneer in AI Robotics and Orthopedics
                      </h1>
                      <p className="text-base md:text-lg font-normal leading-normal text-slate-600 dark:text-slate-400">
              ...
              <div className="flex flex-col lg:flex-row gap-12 mt-10">
                ...
                <aside className="lg:w-1/4 sticky top-24 h-fit">
                  <div className="flex h-full min-h-[500px] flex-col justify-between bg-slate-100 dark:bg-[#111c21] p-4 rounded-lg border border-slate-200 dark:border-slate-800">
                    <div className="flex flex-col gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <h3 className="text-base font-semibold leading-normal dark:text-white">Dr. Hyder Kunnumal</h3>
                          <p className="text-sm font-normal leading-normal text-slate-500 dark:text-slate-400">Orthopedic & Robotic Surgeon</p>
                        </div>
                      </div>
                      <nav className="flex flex-col gap-1 mt-4">
                        {/* Added onClick handlers to sidebar links */}
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#1791cf]/20 dark:bg-[#1791cf]/30 text-[#1791cf] dark:text-white" href="#introduction" onClick={(e) => handleAnchorClick(e, 'introduction')}>
                          <span className="text-xl">👤</span>
                          <p className="text-sm font-medium leading-normal">Introduction</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#education" onClick={(e) => handleAnchorClick(e, 'education')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">🎓</span>
                          <p className="text-sm font-medium leading-normal">Education</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#journey" onClick={(e) => handleAnchorClick(e, 'journey')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">💼</span>
                          <p className="text-sm font-medium leading-normal">Professional Journey</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#achievements" onClick={(e) => handleAnchorClick(e, 'achievements')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">🏆</span>
                          <p className="text-sm font-medium leading-normal">Achievements</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#philosophy" onClick={(e) => handleAnchorClick(e, 'philosophy')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">❤️</span>
                          <p className="text-sm font-medium leading-normal">Philosophy</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#community" onClick={(e) => handleAnchorClick(e, 'community')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">👥</span>
                          <p className="text-sm font-medium leading-normal">Affiliations</p>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-800" href="#personal-note" onClick={(e) => handleAnchorClick(e, 'personal-note')}>
                          <span className="text-xl text-slate-600 dark:text-slate-400">💬</span>
                ...
                <div className="lg:w-3/4 flex flex-col space-y-12">
                  {/* FIX: Added scroll-mt-32 class to all anchor sections */}
                  <section id="introduction" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">Introduction</h2>
                    <p className="text-slate-600 dark:text-slate-300 text-base font-normal leading-relaxed pb-3 pt-1 px-4">A compelling narrative about my passion for **Orthopedics and cutting-edge Robotic Surgery**. From my comprehensive international training to implementing the latest AI-driven surgical techniques, my goal is to combine technical excellence with a deeply humanistic approach. I aim to ensure every individual feels heard, understood, and confident in their treatment journey, focusing on achieving the best long-term outcomes for mobility.</p>
                  </section>

                  <section id="education" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">Education & Qualifications</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
                      <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-lg">
                        <h3 className="font-bold text-lg dark:text-white">MBBS (Bachelor of Medicine, Bachelor of Surgery)</h3>
                        <p className="text-[#1791cf] font-medium">Prestigious Institution, India</p>
                        <p className="text-sm text-slate-500 dark:text-slate-400">Start Year - End Year</p>
                      </div>
                      <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-lg">
                        <h3 className="font-bold text-lg dark:text-white">MS Ortho (Master of Surgery in Orthopedics)</h3>
                        <p className="text-[#1791cf] font-medium">Leading University/Hospital</p>
                        <p className="text-sm text-slate-500 dark:text-slate-400">Year - Year</p>
                      </div>
                      <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-lg">
                        <h3 className="font-bold text-lg dark:text-white">MCh (Orth.) (Master of Chirurgiae in Orthopedics)</h3>
                        <p className="text-[#1791cf] font-medium">University of Dundee, UK</p>
                        <p className="text-sm text-slate-500 dark:text-slate-400">Year - Year</p>
                      </div>
                      <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-lg">
                        <h3 className="font-bold text-lg dark:text-white">Specialized Fellowship/Training</h3>
                  ...
                  <section id="journey" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">Professional Journey</h2>
                    <div className="px-4 relative">
                      <div className="absolute left-6 h-full w-0.5 bg-slate-300 dark:bg-slate-700"></div>
                      <div className="space-y-8">
                        <div className="relative pl-12">
                          ...
                          <h3 className="font-semibold text-lg dark:text-white">Pioneering AI Robotics Surgeries</h3>
                          <p className="text-slate-600 dark:text-slate-300">Successfully performed cutting-edge AI-assisted robotic surgeries, setting a new benchmark for precision and minimal invasiveness in the region.</p>
                        </div>
                        <div className="relative pl-12">
                          <div className="absolute left-6 top-1 w-4 h-4 rounded-full bg-[#1791cf] -translate-x-1/2 transform"></div>
                          <p className="text-sm text-slate-500 dark:text-slate-400">Current Role</p>
                          <h3 className="font-semibold text-lg dark:text-white">Consultant Orthopedic Surgeon</h3>
                  ...
                  <section id="achievements" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">Achievements & Success Stories</h2>
                    <div className="px-4 space-y-4">
                      <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-lg">
                        <h3 className="font-bold text-lg dark:text-white">Pioneer of AI Robotics Surgery</h3>
                      ...
                      <blockquote className="border-l-4 border-[#1791cf] pl-4 italic text-slate-600 dark:text-slate-300">
                  ...
                  <section id="philosophy" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">My Philosophy & Approach</h2>
                    <p className="text-slate-600 dark:text-slate-300 text-base font-normal leading-relaxed pb-3 pt-1 px-4">I believe in a patient-centric approach where you are a partner in your own healthcare journey. My philosophy is built on three pillars: **Advanced Robotic and AI techniques**, **personalized care plans**, and **clear, honest communication**. The goal is always to leverage the highest level of surgical precision to ensure the least invasive procedure, prioritizing your long-term well-being and a swift, active return to life.</p>
                  </section>

                  <section id="community" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">Current Affiliations</h2>
                    <div className="px-4 space-y-2">
                      <details className="group bg-slate-100 dark:bg-slate-800/50 p-4 rounded-lg" open>
                        <summary className="font-semibold cursor-pointer flex justify-between items-center dark:text-white">
                          Malabar Hospitals, Manjeri
                        </summary>
                        <p className="mt-2 text-slate-600 dark:text-slate-300">Consultant Orthopedic Surgeon, specializing in complex joint replacements and sports injury management. A key location for my AI robotics practice.</p>
                      </details>
                      <details className="group bg-slate-100 dark:bg-slate-800/50 p-4 rounded-lg" open>
                        <summary className="font-semibold cursor-pointer flex justify-between items-center dark:text-white">
                  ...
                  <section id="personal-note" className="scroll-mt-32">
                    <h2 className="text-2xl font-bold leading-tight tracking-tight px-4 pb-3 pt-5 dark:text-white">A Personal Note</h2>
                    <div className="px-4">
                      <blockquote className="bg-[#1791cf]/10 dark:bg-[#1791cf]/20 border-l-4 border-[#1791cf] p-6 rounded-r-lg">
                        <p className="text-lg italic text-slate-800 dark:text-slate-200">"The greatest reward of my work is seeing my patients reclaim their lives from pain and limitation. Leveraging the power of AI and robotics allows me to achieve unparalleled precision, translating to better, faster recoveries for you. My promise is to provide not just my surgical skill, but my unwavering support and dedication to your journey to complete mobility."</p>
                  ...
                  <section className="text-center py-10 scroll-mt-32" id="contact">
                    <h2 className="text-3xl font-bold mb-4 dark:text-white">Ready to Take the Next Step?</h2>
          ...
          {/* Footer */}
          <footer className="bg-slate-200 dark:bg-[#111c21] border-t border-slate-300 dark:border-slate-800 mt-16">
            <div className="max-w-[1280px] mx-auto px-4 md:px-10 lg:px-20 xl:px-40 py-8 text-center text-slate-600 dark:text-slate-400 text-sm">
