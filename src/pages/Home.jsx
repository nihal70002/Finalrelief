...
export default function Home() {
  return (
    <main>
      <SEO
        title="Dr Hyder Kunnummal | Orthopedic Doctor in Manjeri, Kerala"
        description="Consult Dr Hyder Kunnummal, orthopedic doctor in Manjeri for knee replacement, arthritis treatment, sports injury care and joint pain relief."
        path="/"
      />
      <HeroSection />
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="mb-10 text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Dr Hyder Kunnummal – Orthopedic Doctor in Manjeri
            </h1>
          ...
          <article className="prose prose-lg max-w-none dark:prose-invert text-gray-700 dark:text-gray-300 space-y-5">
            ...
            <p>
              If you are searching for an orthopedic doctor in Manjeri, knee replacement Manjeri, or orthopedic treatment in Malappuram, this website provides information about Dr Hyder Kunnummal’s expertise, available treatments, patient recovery stories, and contact details. Patients can learn about treatment options, understand when to seek help, and connect for consultation through the contact page.
            </p>
          </article>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            ...
            >
              Contact Dr Hyder Kunnummal for orthopedic consultation
            </Link>
          </div>
        </div>
      </section>
